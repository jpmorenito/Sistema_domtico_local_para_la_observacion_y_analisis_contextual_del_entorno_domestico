...
A continuación, se presenta la especificación del archivo de orquestación \texttt{docker-compose.yml}:

\begin{lstlisting}[language=YAML, caption={Archivo de orquestación de contenedores en la Raspberry Pi 4 (docker-compose.yml).}, label={lst:docker_compose}]
version: '3.8'
...
\subsection{Automatizaciones del orquestador perimetral (Home Assistant)}
