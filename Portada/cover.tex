...
\vfill
\vfill
\includegraphics[width=11.5cm]{Portada/Img/LogotipoEPSC}
\vfill

{\color{epsc:verde}
\large

\textbf{TRABAJO FINAL DE GRADO}
...
\vspace{6.79mm}
\textbf{Córdoba, {\monthname} {\the\year}}     % Fecha de compilación en formato mes, año
