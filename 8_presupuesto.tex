...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|}
        \hline
        \parbox[c]{3.2cm}{\vspace{0.15cm}\centering\textbf{Software /\\Plataforma}\vspace{0.15cm}} & \parbox[c]{3.0cm}{\centering\textbf{Tipo de\\Licencia}} & \parbox[c]{3.8cm}{\centering\textbf{Uso en el\\Proyecto}} & \parbox[c]{1.5cm}{\centering\textbf{Coste\\(\euro)}} \\ \hline
        \parbox[c]{3.2cm}{\vspace{0.1cm}Raspberry Pi OS (Debian)\vspace{0.1cm}}       & \parbox[c]{3.0cm}{\centering\vspace{0.1cm}Código Abierto\\(GPL)\vspace{0.1cm}}      & \parbox[c]{3.8cm}{\vspace{0.1cm}Sistema operativo host\vspace{0.1cm}}      & 0.00 \\ \hline
        \parbox[c]{3.2cm}{\vspace{0.1cm}Docker Community Edition\vspace{0.1cm}}       & \parbox[c]{3.0cm}{\centering\vspace{0.1cm}Código Abierto\\(Apache)\vspace{0.1cm}}   & \parbox[c]{3.8cm}{\vspace{0.1cm}Orquestación de contenedores\vspace{0.1cm}}& 0.00 \\ \hline
        \parbox[c]{3.2cm}{\vspace{0.1cm}Portainer Community Edition\vspace{0.1cm}}    & \parbox[c]{3.0cm}{\centering\vspace{0.1cm}Libre con\\restricciones\vspace{0.1cm}}   & \parbox[c]{3.8cm}{\vspace{0.1cm}Panel de control Docker\vspace{0.1cm}}     & 0.00 \\ \hline
        \parbox[c]{3.2cm}{\vspace{0.1cm}Home Assistant Container\vspace{0.1cm}}       & \parbox[c]{3.0cm}{\centering\vspace{0.1cm}Código Abierto\\(Apache)\vspace{0.1cm}}   & \parbox[c]{3.8cm}{\vspace{0.1cm}Orquestador domótico central\vspace{0.1cm}}& 0.00 \\ \hline
        ESPHome suite                  & \parbox[c]{3.0cm}{\centering\vspace{0.1cm}Código Abierto\\(MIT/GPL)\vspace{0.1cm}}  & \parbox[c]{3.8cm}{\vspace{0.1cm}Compilador cruzado firmware\vspace{0.1cm}}  & 0.00 \\ \hline
        \parbox[c]{3.2cm}{\vspace{0.1cm}Base de datos SQLite\vspace{0.1cm}}           & Dominio Público           & \parbox[c]{3.8cm}{\vspace{0.1cm}Motor de almacenamiento HA\vspace{0.1cm}}  & 0.00 \\ \hline
        \parbox[c]{3.2cm}{\vspace{0.1cm}VPN Tailscale (Free tier)\vspace{0.1cm}}      & Comercial Gratuita        & \parbox[c]{3.8cm}{\vspace{0.1cm}Acceso remoto cifrado\vspace{0.1cm}}       & 0.00 \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|r|}
        \hline
        \parbox[c]{4.6cm}{\vspace{0.15cm}\centering\textbf{Fase de ingeniería}\vspace{0.15cm}} & \parbox[c]{2.0cm}{\centering\textbf{Horas\\dedicadas}} & \parbox[c]{2.2cm}{\centering\textbf{Precio/Hora\\(\euro)}} & \parbox[c]{2.2cm}{\centering\textbf{Coste total\\(\euro)}} \\ \hline
