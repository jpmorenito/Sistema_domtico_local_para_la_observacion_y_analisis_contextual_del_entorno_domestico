...
\begin{itemize}
    ...
    \item \textbf{Estímulo de entrada:} cambio a \texttt{on} en el radar del escritorio (\texttt{binary\_}\allowbreak\texttt{sensor.}\allowbreak\texttt{radar\_}\allowbreak\texttt{presence}) con una lectura del LDR por debajo de 200\,lx (\texttt{sensor.}\allowbreak\texttt{ldr\_}\allowbreak\texttt{iluminancia}).
    \item \textbf{Flujo esperado en la traza:} el servidor intercepta el disparo, valida la oscuridad y activa el relé de iluminación (\texttt{switch.}\allowbreak\texttt{ssr\_}\allowbreak\texttt{rele\_}\allowbreak\texttt{iluminacion} a \texttt{on}).
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/iluminacion_activa_1.png}
        \caption{Disparo inicial.}
        \label{fig:iluminacion_activa_1}
    \end{subfigure}
    \\ \vspace{0.4cm}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/iluminacion_activa_2.png}
        \caption{Evaluación de condiciones.}
        \label{fig:iluminacion_activa_2}
    \end{subfigure}
    \\ \vspace{0.4cm}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/iluminacion_activa_3.png}
        \caption{Encendido del relé.}
        \label{fig:iluminacion_activa_3}
    \end{subfigure}
...
\begin{itemize}
    ...
    \item \textbf{Estímulo de entrada:} cambio en el estado del sensor del receptor magnético de la puerta (\texttt{binary\_sensor.}\allowbreak\texttt{puerta\_reed} a \texttt{on}) o cambio del receptor de la barrera óptica láser a estado sin luz (\texttt{binary\_sensor.}\allowbreak\texttt{laser\_receptor} a \texttt{on}).
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/alarma_seguridad_1.png}
        \caption{Detección del intruso.}
        \label{fig:alarma_seguridad_1}
    \end{subfigure}
    \\ \vspace{0.4cm}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/alarma_seguridad_2.png}
        \caption{Evaluación del armado.}
        \label{fig:alarma_seguridad_2}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/alarma_seguridad_3.png}
        \caption{Disparo de alarma.}
        \label{fig:alarma_seguridad_3}
    \end{subfigure}
    \caption{Traza de depuración en Home Assistant para el caso de prueba PR-AUTO-02 (cont.).}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Estímulo de entrada:} permanencia ininterrumpida de la entidad de presencia del radar (\texttt{binary\_sensor.}\allowbreak\texttt{radar\_presence} en estado \texttt{on}) durante un periodo acumulativo continuo superior a $25\,\text{minutos}$.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/pomodoro_1.png}
        \caption{Inicio del temporizador.}
        \label{fig:pomodoro_1}
    \end{subfigure}
    \\ \vspace{0.4cm}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/pomodoro_2a.png}
        \caption{Evaluación del flujo lógico de condiciones.}
        \label{fig:pomodoro_2a}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/pomodoro_2b.png}
        \caption{Evaluación del flujo lógico de condiciones.}
        \label{fig:pomodoro_2b}
    \end{subfigure}
    \\ \vspace{0.4cm}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/pomodoro_3.png}
        \caption{Ejecución del bucle de parpadeo de aviso.}
        \label{fig:pomodoro_3}
    \end{subfigure}
    \caption{Traza de depuración en Home Assistant para el caso de prueba PR-AUTO-03 (cont.).}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Estímulo de entrada:} ausencia absoluta de movimiento por el radar mmWave (\texttt{binary\_sensor.}\allowbreak\texttt{radar\_presence} en estado \texttt{off}) durante un retardo de cortesía de $10\,\text{minutos}$, o conmutación manual del conmutador de cabecera a modo \texttt{Noche}.
    \item \textbf{Flujo esperado en la traza:} el servidor central evalúa la persistencia del estado de reposo, ejecuta la transición de la máquina de estados a \texttt{Ausente} o \texttt{Durmiendo} y desencadena un comando de apagado masivo de todos los relés y actuadores del sistema (\texttt{switch.}\allowbreak\texttt{ssr\_rele\_iluminacion} a \texttt{off}, etc.).
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/ausencia_automatica_1.png}
        \caption{Inactividad en radar.}
        \label{fig:ausencia_automatica_1}
    \end{subfigure}
    \\ \vspace{0.4cm}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/ausencia_automatica_2.png}
        \caption{Verificación de estado.}
        \label{fig:ausencia_automatica_2}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Img/Pruebas/ausencia_automatica_3.png}
        \caption{Paso a modo Ausente.}
        \label{fig:ausencia_automatica_3}
    \end{subfigure}
    \caption{Traza de depuración en Home Assistant para el caso de prueba PR-AUTO-04 (cont.).}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|l|}
        \hline
        \rowcolor[gray]{0.9} 
        \multicolumn{1}{|c|}{\textbf{Componente}} & \textbf{Voltaje (V)} & \textbf{Corriente (mA)} & \textbf{Potencia (W)} & \multicolumn{1}{c|}{\textbf{Régimen}} \\ \hline
