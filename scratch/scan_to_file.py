...
tex_files = [
    '1_introduccion.tex', '2_contexto_estado_arte.tex', '3_analisis_requisitos.tex', 
...
for f_name in tex_files:
    ...
    if not os.path.exists(f_name):
        out_lines.append(f"  File not found!\n")
        continue
    ...
    for line_num, line in enumerate(lines, 1):
        ...
        # Ignore lines with TikZ/drawing commands
        ...
        for word in words:
            ...
            out_lines.append(f"  Line {line_num}: Word '{word}'\n")
            out_lines.append(f"    Context: ...{line_strip[max(0, idx-30):min(len(line_strip), idx+45)]}...\n")

with open('scratch/candidates.txt', 'w', encoding='utf-8') as f:
    f.writelines(out_lines)

print("Scan complete! Output written to scratch/candidates.txt")
