...
# Step 1: Restore backup to target
...
with Image.open(img_dest) as img:
    ...
    # Crop the original unmirrored ESP32 board so we can paste it back after cleaning the breadboard
    esp_crop = img.crop((342, 190, 682, 590))
    print("Cropped original unmirrored ESP32 board.")
    ...
    # Clean left side of breadboard (x=52 to 342)
    ...
    # 4. Paste the original unmirrored ESP32 board back in its original position
    img.paste(esp_crop, (342, 190))
    print("Pasted original unmirrored ESP32 board back.")
    ...
    # --- DHT11 connections (Left side of breadboard) ---
    ...
    # Route: up to y=335, right across the board to x=730, down to y=400, left to pin.
    ...
    # Route: up to y=308, right to x=326
    ...
    # OUT (x=508) -> ESP32 D27 (left side, row 10, x=326, y=382)
    # Route: up to y=382, left to x=326
    draw_wire([(508, 715), (508, 382), (326, 382)], orange_core, orange_border)
