...
\end{lstlisting}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{Img/ha_dashboard_lovelace.png}
        \caption{Cuadro de mando Lovelace en Home Assistant mostrando las telemetrías y transiciones contextuales.}
